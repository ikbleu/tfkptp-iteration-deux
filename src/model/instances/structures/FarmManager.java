...
public class FarmManager extends SpecificStructureManager {
	...
	public FarmManager(Player p, GeneralStructureManager m, WorkerManager wm) {
		super( m, new FarmFactory( p, wm ), p, p.handFactory().make( Device.class ),
				BASE_STATS, DELTA_STATS, RESOURCE_COST, "Farm" );
		player = p;
		
		p.addCommandListener( "cmdBuildFarm", new CommandListener() {
