...
public class ObservationTowerManager extends SpecificStructureManager {
	...
	public ObservationTowerManager(Player p, GeneralStructureManager m, WorkerManager wm) {
		super( m, new ObservationTowerFactory( p, wm ), p, p.handFactory().make( Device.class ),
